 ...
 * │                                                                     │
 * │ WHAT THIS FILE IS                                                   │
 * │   A one-off build script that renders public/favicon.svg into the    │
 ...
 * │   The logo is defined once, in favicon.svg. Re-running this script   │
 * │   regenerates every size, so the icons cannot drift out of sync with │
 * │   the brand — which is what happens when someone edits the SVG and   │
...
// Tab favicon fallback for browsers that do not take SVG.
